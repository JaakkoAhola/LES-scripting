...
${jaakkoNL}  minispinupCase02 = ${minispinupCase02:-3}
 ...
 &salsa
   ...
   nlcgaa  = ${nlcgaa:-.TRUE.} ! Coagulation between aerosols

   nlcgcc  = ${nlcgcc:-.TRUE.} ! Collision-coalescence between cloud droplets
   nlcgca  = ${nlcgca:-.TRUE.} ! Cloud collection of aerosols

   nlcgpc  = ${nlcgpc:-.TRUE.} ! Collection of cloud droplets by rain
   nlcgpa  = ${nlcgpa:-.TRUE.} ! Collection of aerosols by rain
   nlcgpp  = ${nlcgpp:-.TRUE.} ! Collision between rain drops

   nlcgia  = ${nlcgia:-.TRUE.} ! Ice collection of aerosols
   nlcgic  = ${nlcgic:-.TRUE.} ! Collection of cloud droplets by ice particles
   nlcgii  = ${nlcgii:-.TRUE.} ! Collision-coalescence between ice particles
   nlcgip  = ${nlcgip:-.TRUE.} ! Collection of precipitation by ice particles

   nlcgsa  = ${nlcgsa:-.FALSE.} ! Collection of aerosols by snow
   nlcgsc  = ${nlcgsc:-.FALSE.} ! Collection of cloud droplets by snow
   nlcgsi  = ${nlcgsi:-.FALSE.} ! Collection of ice by snow
   nlcgsp  = ${nlcgsp:-.FALSE.} ! Collection of precipitation by snow
   nlcgss  = ${nlcgss:-.FALSE.} ! Collision-coalescence between snow particles
