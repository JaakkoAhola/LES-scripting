...
#        print 'WindAppr' + str(WindAppr)
    ...
    def plot(self):
        ...
        mdp.plottaa( self.q, self.z, tit = 'Total water mixing ratio', xl = 'Water mix. rat. [g/kg]', yl = 'height [m]', markers=False, uusikuva = True, LEGEND = True )
        
        mdp.plottaa( self.rh, self.z, tit = 'Relative humidity', xl = 'Rel. humid. [%]', yl = 'height [m]', markers=False, uusikuva = True, LEGEND = True )
        
        mdp.plottaa( self.u, self.z, tit = 'Horizontal wind U', xl = 'U wind [m/s]', yl = 'height [m]', markers=False, uusikuva = True, LEGEND = True )
        
        mdp.plottaa( self.v, self.z, tit = 'Horizontal wind V', xl = 'V wind [m/s]', yl = 'height [m]', markers=False, uusikuva = True, LEGEND = True )
